...
namespace CustomComponent {
    ...
    export function initOrderListByDeliveryId(deliveryId) {
        modelInitParams.getData().deliveryId = deliveryId;
        modelInitParams.refresh();
        apiMasterDataApi();
    }

     export function initOrderListByCustomerId(customerId) {
        modelInitParams.getData().customerId = customerId;
        modelInitParams.refresh();
        apiMasterDataApi();
    }
}
